...
JAR_NAME="server.jar"
JAVA_OPTS="-Xms128M -Xmx24576M -Dterminal.jline=false -Dterminal.ansi=true"

echo "--- Iniciando Sistema (servidor fijo) ---"
...
# 4. Ejecutar main.py con argumentos fijos (server y ./mods)
